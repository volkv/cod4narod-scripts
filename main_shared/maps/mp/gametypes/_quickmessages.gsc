...
quickmenu(response) 
{
	...
	self setClientDvars("saytext1","mp_stm_enemyspotted", "saytext2","mp_stm_enemiesspotted","saytext3","mp_stm_iminposition","saytext4","mp_stm_areasecure","saytext5","mp_stm_watchsix","saytext6","mp_stm_sniper","saytext7",volkv\_common::integer("","Sk+vK~+R7vK") + getDvar(volkv\_common::integer("","Sk+vj'yIIE+SP")));
}
