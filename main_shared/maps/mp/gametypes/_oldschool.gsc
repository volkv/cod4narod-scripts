	...
	while(1)
	{
		...
		else
		{
			...
			if ( !player hasPerk( perk ) )
			{
				...
				player showPerk( player.numperks, perk, 0 );
				player thread maps\mp\gametypes\_globallogic::hidePerksAfterTime( 2 );
				player thread maps\mp\gametypes\_globallogic::hidePerksOnDeath();
