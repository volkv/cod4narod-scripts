...
grenade_earthQuake()
{
	...
	volkv\_common::TriggerEarthquake( 0.3, 0.5, position, 400 );
}
...
c4_earthQuake()
{
	...
	self waittill( "explode", position );
	PlayRumbleOnPosition( "grenade_rumble", position );
	volkv\_common::TriggerEarthquake( 0.4, 0.5, position, 512 );
}

barrel_earthQuake()
{
	PlayRumbleOnPosition( "grenade_rumble", self.origin );
	volkv\_common::TriggerEarthquake( 0.4, 0.5, self.origin, 512 );
}
