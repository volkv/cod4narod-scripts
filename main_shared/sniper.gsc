...
{
	level.bordersEnabled = 1;
	level.fixPlayerLoadoutEnabled = 1;
	level.fixExplosiveDamageEnabled = 1;
	level.bordersPunishmentTime = 5;
	level.m21RecoilFix = 0;
	level.extraSpawns = 1;
	level.newScoreUpdate = 1;
	level.changeTeamFix = 1;
...
borderPunishment()
{
	...
	self iPrintLnBold( self volkv\_common::getLangString("BORDER_PUNISH") );
...
self TakeAllWeapons();      
  ...
  setDvar("aim_automelee_enabled", 2);     
  setDvar("player_meleeRange", 2);      
