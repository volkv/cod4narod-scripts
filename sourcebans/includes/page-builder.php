...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-56205581-2"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-56205581-2');
</script>
...
<script type="text/javascript" >
    (function (d, w, c) {
        (w[c] = w[c] || []).push(function() {
            try {
                w.yaCounter46809414 = new Ya.Metrika({
                    id:46809414,
                    clickmap:true,
                    trackLinks:true,
...
<noscript><div><img src="https://mc.yandex.ru/watch/46809414" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<?php
