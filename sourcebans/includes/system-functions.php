...
{
	global $userbank;
	AddTab("На форум", "/", "Общая информация по серверам и банам");
	AddTab("Сводка", "index.php?p=home", "Общая информация по серверам и банам");
	AddTab("Серверы", "index.php?p=servers", "Игровые серверы CoD4Narod и их статус");
	AddTab("Скриншоты", "/screenshots/index.php", "Скриншоты игроков");
	AddTab("&nbsp;Баны&nbsp;", "index.php?p=banlist", "Список банов по всем серверам");
	AddTab("Предложить бан", "index.php?p=submit", "Вы можете пожаловаться на игрока, предоставить скриншоты и он будет забанен");
	...
	if ($userbank->is_admin())
		AddTab(" Админка ", "index.php?p=admin", "Для админов");
...
function BuildBreadcrumbs()
{
	...
	if(isset($_GET['c']))
	{
		...
		{
			case "admins":
				$cat = "Настройка Админов";
				break;
			case "servers":
				$cat = "Настройка Серверов";
				break;
			case "bans":
			...
			case "comms":
				...
				break;
			case "groups":
				$cat = "Упарвление группами";
				break;
			case "settings":
				$cat = "Настройка SourceBan";
				break;
			case "mods":
				$cat = "Настройка Модов";
				break;
