...
<br />
<div id="banlist-nav"><i>Всего банов: {$total_bans}</i></div>
<div id="banlist">
	<table width="100%" cellspacing="0" cellpadding="0" align="center" class="listtable">
		<tr>
			...
			{/if}
			<td width="12%" height="16" class="listtable_top" align="center"><b>Страна</b></td>
			<td width="14%" height="16" class="listtable_top" align="center"><b>Время</b></td>
        ...
        <td height="16" class="listtable_1">
		  ...
		  <img src="images/demo.gif" alt="Demo" title="Есть доказательства преступления" style="height:14px;width:14px;" />
		  </div>
		  {/if}
        ...
        <td colspan="7" align="center">
          <div class="opener"> 
              ...
              {if $ban.type == 0}
              <tr align="left">
                <td width="20%" height="16" class="listtable_1">COD4 GUID</td>
                <td height="16" class="listtable_1">{$ban.communityid}</td>
              </tr>
              {/if}
              {if !$hideplayerips}
              <tr align="left">
                ...
                <td height="16" class="listtable_1">
                  {if $ban.ip == "none"}
                    <i><font color="#677882">нет IP</font></i>
                  {else}
                    {$ban.ip}
                  {/if}
                </td>
              ...
              {/if}
              <tr align="left">
								<td width="20%" height="16" class="listtable_1">Бан выписан</td>
							...
							{/if}
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Откуда бан</td>
							...
							<tr align="left">
								<td width="20%" height="16" class="listtable_1">Попыток зайти ({$ban.blockcount})</td>
								<td height="16" class="listtable_1">
								{if $ban.banlog == ""}
									<i><font color="#677882">не было</font></i>
								{else}
									{$ban.banlog}
								{/if}
								</td>
	...
	<!--<hr>-->
	<br> <!-- delete this if you have to uncomment that hr -->
	{/if}
	{if $can_export }
