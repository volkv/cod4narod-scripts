    		...
    		<td>
    			<div align="left">
					...
					<optgroup label="Hacking">
						<option value="^1You are in server's blacklist. Please visit ^2CoD4Narod.RU         ^1BbI B 4EPHOM CnuCKE. CauT nPoeKTa ^2CoD4Narod.RU">Aimbot</option>
			
					</optgroup>
					<optgroup label="Behavior">
						<option value="^1You are in server's blacklist. Please visit ^2CoD4Narod.RU         ^1BbI B 4EPHOM CnuCKE. CauT nPoeKTa ^2CoD4Narod.RU">Team Killing</option>
